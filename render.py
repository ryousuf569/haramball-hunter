...
def run_simulation(n_att=10, n_def=11, seed=100, n_ticks=2500, interval_ms=None,
                   show_zones=False, start_holder=1, show_ppcf=True,
                   checkpoint='5M.pt', deterministic=True, max_ticks=None):
